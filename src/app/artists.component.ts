          ...
          <div *ngFor="let artist of artists" 
            ...
            <div class="text-center">
              <div class="flex items-center justify-center gap-2 mb-2">
                ...
                <svg *ngIf="artist.verified" class="w-5 h-5 text-cyan-400" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex justify-center gap-4 mb-6">
                <a *ngFor="let social of artist.socialLinks" 
                   ...
                   class="p-2 bg-gray-700 hover:bg-gray-600 rounded-full transition-colors group"
